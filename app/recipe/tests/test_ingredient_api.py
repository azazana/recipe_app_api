...
def detail_url(ingredient_id):
    """Create and return url for the ingredient."""
    return reverse("recipe:ingredient-detail", args=[ingredient_id])


def create_user(email="user@example.com", password="123testpass"):
...
class PrivateIngredientsAptTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """Test list for ingredients is limited to authenticated user."""
        user2 = create_user(email="test@example.com", password="pass123!")
